...
public class Dessin extends JPanel{
     ...
     */
    private final List<IObjetDessinable> listeObjet = new CopyOnWriteArrayList();
     ...
     * @see train
     */
    public void ajouterObjet(IObjetDessinable objet) {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (IObjetDessinable Objet : listeObjet) {
            Objet.dessiner(g);
        }
    }
    ...
    public void animer() {
        ...
        for (IObjetDessinable objet : listeObjet) {
        	if (objet instanceof IObjetAnnimable) {
        		((IObjetAnnimable) objet).deplacer();
        	}  
        }
    }

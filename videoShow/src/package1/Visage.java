...
public class Visage extends FormeCirculaire implements IObjetAnnimable {
	 // ---------------------------------------------------------
     ...
     */
    private static int dx = DEPLACEMENT_DEFAUT;
    ...
    super(xg,yg,larg,haut,Color.orange,Color.black);
        this.d = d;
        this.xhg = xg;
        this.yhg = yg;
    ...
    public void dessiner(Graphics g) {
    	...
    	graphic.translate(x/4, y/4);
    	graphic.drawOval(xhg, yhg, largeur, hauteur);

        // dessiner la bouche
        if (impassible) {
        	graphic.drawLine(xhg + largeur / 4, yhg + (2 * hauteur) / 3,xhg + (3 * largeur) / 4, yhg + (2 * hauteur) / 3);
                    
        } else {
        	graphic.drawArc(xhg + largeur / 4, yhg + (2 * hauteur) / 3, largeur / 2, hauteur / 5, -45, -90);
        ...
        graphic.drawOval(xhg + largeurOeil, yhg + hauteurOeil, largeurOeil, hauteurOeil);
        graphic.drawOval(xhg + 3 * largeurOeil, yhg + hauteurOeil, largeurOeil,hauteurOeil);
